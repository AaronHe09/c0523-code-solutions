...
function renderPokemon(pokemon) {
  ...
  const $pokemonTextCard = document.createElement('div');
  ...
  $columnOneThird.appendChild($pokemonCard);
  $pokemonCard.appendChild($image);
  $pokemonCard.appendChild($pokemonTextCard);
  $pokemonTextCard.appendChild($h2);
  $pokemonTextCard.appendChild($h3);
  $pokemonTextCard.appendChild($p);
