...
console.log(
  `the title of this book is ${title}, the author is ${author}, and the library id is ${libraryID}`
);
...
console.log(
  `The title of this is book is ${title2}, the author is ${author2}, and the library id is ${libraryID2}`
);
